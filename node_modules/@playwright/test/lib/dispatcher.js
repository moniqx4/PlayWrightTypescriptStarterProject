...
class Dispatcher {
  ...
  async _runJob(worker, testGroup) {
    ...
    const onTestBegin = params => {
      ...
      (_this$_reporter$onTes = (_this$_reporter = this._reporter).onTestBegin) === null || _this$_reporter$onTes === void 0 ? void 0 : _this$_reporter$onTes.call(_this$_reporter, test, testRun);
    };
    ...
    const onStepBegin = params => {
      ...
      (_this$_reporter$onSte = (_this$_reporter2 = this._reporter).onStepBegin) === null || _this$_reporter$onSte === void 0 ? void 0 : _this$_reporter$onSte.call(_this$_reporter2, test, result, step);
    };
    ...
    const onStepEnd = params => {
      ...
      if (!step) {
        ...
        (_this$_reporter$onStd = (_this$_reporter3 = this._reporter).onStdErr) === null || _this$_reporter$onStd === void 0 ? void 0 : _this$_reporter$onStd.call(_this$_reporter3, 'Internal error: step end without step begin: ' + params.stepId, test, result);
        return;
      }
      ...
      (_this$_reporter$onSte2 = (_this$_reporter4 = this._reporter).onStepEnd) === null || _this$_reporter$onSte2 === void 0 ? void 0 : _this$_reporter$onSte2.call(_this$_reporter4, test, result, step);
    };
    ...
    const onDone = params => {
      ...
      worker.stop();
      worker.didFail = true; // In case of fatal error, report first remaining test as failing with this error,
      ...
      if (params.fatalError) {
        ...
        for (const test of remaining) {
          ...
          if (test._id !== lastStartedTestId) (_this$_reporter$onTes2 = (_this$_reporter5 = this._reporter).onTestBegin) === null || _this$_reporter$onTes2 === void 0 ? void 0 : _this$_reporter$onTes2.call(_this$_reporter5, test, result);
        ...
        if (first) {
          ...
          (_this$_reporter$onErr = (_this$_reporter6 = this._reporter).onError) === null || _this$_reporter$onErr === void 0 ? void 0 : _this$_reporter$onErr.call(_this$_reporter6, params.fatalError);
